 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function createExtension($name)
        {
                        /** @var \Tpetry\PostgresqlEnhanced\Schema\Builder $instance */
                        return $instance->createExtension($name);
        }
                    /**
         ...
         * @static 
         */ 
        public static function createExtensionIfNotExists($name)
        {
                        /** @var \Tpetry\PostgresqlEnhanced\Schema\Builder $instance */
                        return $instance->createExtensionIfNotExists($name);
        }
                    /**
...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Testing\TestResponse::expectsFalse($throwable, $exceptions);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function expectsTrue($throwable = null, $exceptions = [])
        {
                        return \Illuminate\Testing\TestResponse::expectsTrue($throwable, $exceptions);
        }
